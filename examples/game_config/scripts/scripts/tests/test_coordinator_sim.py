...
sys.path.insert(0, os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'agents', 'coordinator_memory', 'process'))

from hfsm_registry import build_hfsm
import coordinator_hooks as hooks

DATA_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'agents', 'coordinator_memory', 'data')
