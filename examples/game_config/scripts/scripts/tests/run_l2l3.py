...
# 看 align_report
ar = json.load(open(os.path.join(os.path.join(BASE, 'agents', 'executor_memory', 'data'), 'align_result.json'), encoding='utf-8'))
...
fr = json.load(open(os.path.join(os.path.join(BASE, 'agents', 'executor_memory', 'data'), 'filled_result.json'), encoding='utf-8'))
